...
**To-do list** is an app that helps to organize your day. It simply lists the things that you need to do and allows you to mark them as complete. Built using ES6 and Webpack and inspired by the [minimalist website](https://web.archive.org/web/20180320194056/http://www.getminimalist.com:80/). 
...
```sh
cd my-folder
git clone git@github.com:rmiyoyo/Todo-List-App.git
```
